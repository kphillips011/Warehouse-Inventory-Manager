...
public class Inventory {
  ...
  public void sortAscendingQuantity() {
    List<Map.Entry<Integer, Product>> productQuantity = new ArrayList<>(inventory.entrySet());
    productQuantity.sort(Collections.reverseOrder(new DescendingQuantity()));
    inventory = new LinkedHashMap<Integer, Product>();
    for (Map.Entry<Integer, Product> i : productQuantity) {
      inventory.put(i.getKey(), i.getValue());
    }
  }

  // return the Inventory sorted by item quantity, in descending order
  public void sortDescendingQuantity() {
    List<Map.Entry<Integer, Product>> productQuantity = new ArrayList<>(inventory.entrySet());
    productQuantity.sort(new DescendingQuantity());
    inventory = new LinkedHashMap<Integer, Product>();
    for (Map.Entry<Integer, Product> i : productQuantity) {
      inventory.put(i.getKey(), i.getValue());
    }
  ...
  public void sortAscendingPrice() {
    List<Map.Entry<Integer, Product>> productPrice = new ArrayList<>(inventory.entrySet());
    productPrice.sort(Collections.reverseOrder(new DescendingPrice()));
    inventory = new LinkedHashMap<Integer, Product>();
    for (Map.Entry<Integer, Product> i : productPrice) {
      inventory.put(i.getKey(), i.getValue());
    }
  }
  ...
  public void sortDescendingPrice() {
    List<Map.Entry<Integer, Product>> productPrice = new ArrayList<Map.Entry<Integer, Product>>();
    for (Map.Entry<Integer, Product> entry : inventory.entrySet()) {
      productPrice.add(entry);
    }
    // implement new Comparator to sort in descending order
